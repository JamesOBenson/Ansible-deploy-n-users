...
2. Modify list of variables contained inside, particularly:
  ...
  *  Note:  There are a 3 times these variables are listed, be sure that they are all the same.  This will be fixed when I refactor my code next....
...
2. Copies all of home directories that were stored local to all of the remote followers locations
...
4. Similar to above, I take no responsibility for loss of data.

##How is this playbook licensed?

It's licensed under the Apache License 2.0. The quick summary is:

> A license that allows you much freedom with the software, including an explicit right to a patent. "€œState changes" means that you have to include a notice in each file you modified. 
